...
function MentalModel(){
    ...
    return(
        <div>
            <div className="m-4 border border-black w-80 flex">
                <input onChange={(e) => handleChanges(e)} className="outline-none pl-1 w-full" placeholder="Enter Password" type={show ? 'text' : 'password'} />
